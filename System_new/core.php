...
defined('BEHAVIOR_PATH') or define('LIB_PATH',LIB_PATH.'Behavior/');
...
if(version_compare(PHP_VERSION,'5.4.0','<')){
	...
	define('MAGIC_QUOTES_GPC',function_exists('get_magic_quotes_pgc')?true:false);
}else{
...
if(!IS_CLI){
	...
	if(!defined('__ROOT__')){
		$_root = rtrim(_PHP_FILE_,'/');
		define('__ROOT__',(($_root=='/'||$_root=='\\')?'',$_root))
	}
}
require CORE_PATH.'Think'.CONF_EXT;
Think\Think::start();
?>